...
@ManagedBean(name="enquiryService")
@SessionScoped
public class EnquiryService implements Serializable{
	
	 private static final Logger log = Logger.getLogger(EnquiryService.class.getName());

...
private static final Logger log = LogManager.getLogger(Plot3bhkService.class);
	...
	private String email="";
	    ...
	    public Plot3bhkService()
		{
			
			log.info("Loading  Plot3bhkService init()");
		...
		public void loadEntities() {
			...
			villaModel=gDao.getPlot3bhkProperties(pageSize,currentPage);
	 	...
	 	public void countTotalRecords() {
	 		...
	 		totalRecords=gDao. getplot3bhkCountTotalRecords();
	    ...
	    public void storeSelectedPropertyInSession() {
	        ...
	        session.setAttribute("selectedPlot3bhk", selectedProperty);
	    }
		...
		public void submit() {
	        ...
	        if (session != null) {
	         	selectedProperty= (VillaModel) session.getAttribute("selectedPlot3bhk");

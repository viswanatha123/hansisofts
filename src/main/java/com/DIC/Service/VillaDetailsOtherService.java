...
@ManagedBean(name="villaDetailsOtherService")
@RequestScoped
public class VillaDetailsOtherService {
	
	private static final Logger log = LogManager.getLogger(VillaDetailsOtherService.class);
	...
	private String email;
	    ...
	    public void init()
	    {
	    	log.info("Loading villaDetailsOtherService init()");
